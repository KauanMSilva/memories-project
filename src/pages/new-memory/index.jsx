...
const NewMemory = () => {
    ...
    const onSetImage = (event) => {
        ...
        //Gerar thumbnails das imagens para mostrar na tela.
        for (let contador = 0; contador < files.lenght; contador++) {

            const file = files[contador];

            const thumbnail = URL.createObjectURL(file); //Criar Thumbnail.

            imageURLs.push(thumbnail); // .PUSH ACRESCENTA NA LISTA.
        }
...
<footer className="app-footer">
    <p>Mnemosyne - Kauan Mariano Silva</p>
</footer>
